Instalación del API:
--------------------
1) Descomprimir el archivo "API v1.0.0 Installer.zip" en el directorio de instalación
2) Descargar de https://nodejs.org/en/ la versión 12.19.0 o superior de node.js correspondiente a la plataforma.
...
-----------------------------------
1) Utilizando un navegador Web, acceder a la URL "http://localhost:8081/docs/"

Resetear la base de datos del API:
----------------------------------
1) En caso de que estuviera ejecutando, detener el API.
2) Copiar el archivo "exercise.sqlite3" que se encuentra en el archivo "API v1.0.0 Installer.zip" a el subdirectorio "db" del directorio de instalación.